...
public final class IntCodec implements Codec<Integer> {
    ...
    public IntCodec(byte reservedByte) {
        super();
        size1 = reservedByte;
    ...
    @Override
    public Integer read(InputStreamWrapper wrapper) throws IOException {
        ...
        switch (marker - size1) {
            case 0:
                return (int) wrapper.read1();
            case 1:
                return (int) wrapper.read2();
            case 2:
                return wrapper.read3();
            case 3:
                return wrapper.read4();
            default:
                throw new IOException("Could not deserialize as an int.");
        }
    }

    @Override
    public void write(OutputStreamWrapper wrapper, Integer value) throws IOException {
        if (value == null) {
