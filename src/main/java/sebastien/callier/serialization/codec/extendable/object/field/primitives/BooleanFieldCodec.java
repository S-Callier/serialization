 ...
 * @since 2018
 */
public class BooleanFieldCodec implements FieldCodec {
    private final Getter get;
    private final Setter set;
    private final Codec codec;

    public BooleanFieldCodec(
            Method getter,
            Method setter,
            Codec codec) throws CodecGenerationException {
        super();
        get = LambdaMetaFactoryUtils.wrapGetter(Getter.class, getter, boolean.class);
        set = LambdaMetaFactoryUtils.wrapSetter(Setter.class, setter, boolean.class);
        this.codec = codec;
    }

    @FunctionalInterface
    public interface Getter {
        boolean get(Object instance);
    }

    @FunctionalInterface
    public interface Setter {
        void set(Object instance, boolean value);
    }
    ...
    public void read(InputStreamWrapper wrapper, Object instance) throws IOException {
        set.set(instance, (Boolean) codec.read(wrapper));
    }
}