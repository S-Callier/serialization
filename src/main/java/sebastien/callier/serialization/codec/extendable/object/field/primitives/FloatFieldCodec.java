 ...
 * @since 2018
 */
public class FloatFieldCodec implements FieldCodec {
    ...
    public FloatFieldCodec(
        ...
        super();
        get = LambdaMetaFactoryUtils.wrapGetter(Getter.class, getter, float.class);
        set = LambdaMetaFactoryUtils.wrapSetter(Setter.class, setter, float.class);
        this.codec = codec;
    }

    @FunctionalInterface
    public interface Getter {
        float get(Object instance);
    }

    @FunctionalInterface
    public interface Setter {
        void set(Object instance, float value);
    }
    ...
    public void read(InputStreamWrapper wrapper, Object instance) throws IOException {
        set.set(instance, (Float) codec.read(wrapper));
    }
}