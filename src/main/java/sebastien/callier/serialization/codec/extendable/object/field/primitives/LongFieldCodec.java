 ...
 * @since 2018
 */
public class LongFieldCodec implements FieldCodec {
    ...
    public LongFieldCodec(
        ...
        super();
        get = LambdaMetaFactoryUtils.wrapGetter(Getter.class, getter, long.class);
        set = LambdaMetaFactoryUtils.wrapSetter(Setter.class, setter, long.class);
        this.codec = codec;
    }
    ...
    public interface Setter {
        void set(Object instance, long value);
    }
    ...
    public void read(InputStreamWrapper wrapper, Object instance) throws IOException {
        set.set(instance, (Long) codec.read(wrapper));
    }
}