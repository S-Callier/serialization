 ...
 * @since 2018
 */
public class ShortFieldCodec implements FieldCodec {
    private final Getter get;
    private final Setter set;
    private final Codec codec;

    public ShortFieldCodec(
            Method getter,
            Method setter,
            Codec codec) throws CodecGenerationException {
        super();
        get = LambdaMetaFactoryUtils.wrapGetter(Getter.class, getter, short.class);
        set = LambdaMetaFactoryUtils.wrapSetter(Setter.class, setter, short.class);
        this.codec = codec;
    }

    @FunctionalInterface
    public interface Getter {
        short get(Object instance);
    }

    @FunctionalInterface
    public interface Setter {
        void set(Object instance, short value);
    }
    ...
    public void read(InputStreamWrapper wrapper, Object instance) throws IOException {
        set.set(instance, (Short) codec.read(wrapper));
    }
}