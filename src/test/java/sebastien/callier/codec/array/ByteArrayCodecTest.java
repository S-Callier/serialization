...
public class ByteArrayCodecTest {
    ...
    private static final ByteArrayCodec codec = new ByteArrayCodec((byte) 0);
    private static final ByteArrayCodec invalidCodec = new ByteArrayCodec((byte) 50);
    ...
    public void testInvalidData() throws IOException {
        ...
        serializer.append(new byte[0], invalidCodec);
        serializer.close();
    ...
    private void testByteArray(byte[] value) throws IOException {
        Serializer serializer = serializerFactory.newSerializer();
