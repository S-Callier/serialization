...
public class IntCodecTest {
    private static final IntCodec codec = new IntCodec((byte) 0);
    private static final IntCodec invalidCodec = new IntCodec((byte) 50);
    ...
    public void testInvalidData() throws IOException {
        ...
        serializer.append(123, invalidCodec);
        serializer.close();
    ...
    private void testInt(Integer value) throws IOException {
        Serializer serializer = serializerFactory.newSerializer();
