...
public class LongCodecTest {
    private static final LongCodec codec = new LongCodec((byte) 0);
    private static final LongCodec invalidCodec = new LongCodec((byte) 50);
    ...
    public void testInvalidData() throws IOException {
        ...
        serializer.append(123L, invalidCodec);
        serializer.close();
    ...
    private void testLong(Long value) throws IOException {
        Serializer serializer = serializerFactory.newSerializer();
